...
interface OrganizationsExtractData {
  model?: string
}

function OrganizationsExtractNode({ data, selected }: NodeProps<OrganizationsExtractData>) {
  ...
  const icon = getNodeIcon('OrganizationsExtract', 'h-4 w-4')
  const bgColor = getNodeBgColor('OrganizationsExtract')
...
export default memo(OrganizationsExtractNode)
