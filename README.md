...
Agate is built and maintained by [Local Angle](https://localangle.co), and released under the MIT License. [Initial work](https://github.com/minneapolisstartribune/agate-ai) began under the Lenfest AI Collaborative and Fellowship Program at the Minnesota Star Tribune, with additional support from Chicago Public Media and the Reynolds Journalism Institute.
